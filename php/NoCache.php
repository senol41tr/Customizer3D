<?php
    ...
    // NoCache::cleanUpAll(['!DATA', '!BACKUPS', '.git', 'manual-api-examples']); // Exclude array of Directories in same directory (without . or / at the end)
    
    // REPLACE ALL FILES (set version get parameters)
    // NoCache::replaceAllInline(['!DATA', '!BACKUPS', '.git', 'manual-api-examples']); // Exclude array of Directories in same directory (without . or / at the end)
