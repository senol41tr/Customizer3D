...
import {Render3D} from 'customizer3D_dir/three/Render3D.js?c3d=104';
...
import {File} from 'customizer3D_dir/file/File.js?c3d=104';
import {EventsManager} from 'customizer3D_dir/events/EventsManager.js?c3d=104';
import {LocalStorage} from 'customizer3D_dir/cookie/LocalStorage.js?c3d=104';
import {Preloader} from 'customizer3D_dir/preloader/Preloader.js?c3d=104';
import {Settings} from 'customizer3D_dir/settings/Settings.js?c3d=104';
import {Layers} from 'customizer3D_dir/layers/Layers.js?c3d=104';
import {TextLayer} from 'customizer3D_dir/layers/TextLayer.js?c3d=104';
import {ImageLayer} from 'customizer3D_dir/layers/ImageLayer.js?c3d=104';
import {ShapeLayer} from 'customizer3D_dir/layers/ShapeLayer.js?c3d=104';
import {Dragable} from 'customizer3D_dir/dragable/Dragable.js?c3d=104';
import {ContextMenu} from 'customizer3D_dir/contextMenu/ContextMenu.js?c3d=104';
import {Help} from 'customizer3D_dir/help/Help.js?c3d=104';
...
import {ZIndex} from 'customizer3D_dir/utils/ZIndex.js?c3d=104';
import {ShowHideUI} from 'customizer3D_dir/utils/ShowHideUI.js?c3d=104';
import {fitMeshToScreen} from 'customizer3D_dir/utils/fitMeshToScreen.js?c3d=104';
import {ColorEngine} from 'customizer3D_dir/ColorEngine/ColorEngine.js?c3d=104';
import {Sortable} from 'base/customizer3D/sortable/Sortable.js?c3d=104';
...
export class Customizer3D
{
    ...
    async initialize(glbPath, jsPath)
    {
        ...
        if(this.localStorage.get('secureText') == null)
        {
            ...
            secureDiv.innerHTML += '<img src="' + C3D_SERVER + 'svg/plus.svg?c3d=104" alt="Icon" class="close">';
        ...
        controlsDiv.innerHTML = `
            <img src="${C3D_SERVER}svg/zoom-out.svg?c3d=104" class="zoomOut" draggable="false">
            <div class="inputDiv">
                <input type="checkbox" class="checkbox" checked>
                <img src="${C3D_SERVER}svg/${deviceIcon}.svg?c3d=104" class="deviceIcon" draggable="false">
            </div>
            <img src="${C3D_SERVER}svg/zoom-in.svg?c3d=104" class="zoomIn" data-factor="0.01" draggable="false">
        `;
        ...
        webXRDiv.innerHTML = `
            <img src="${C3D_SERVER}svg/xr.svg?c3d=104" class="button" alt="XR Button" draggable="false">
        `;
    ...
    async _createLayerData()
    {
        ...
        exportAsPDFButton.addEventListener('click', (e) =>
        {
            ...
            notice = notice.replace('[ILLUSTRATOR_SCREENSHOT]', '<a href="' + C3D_SERVER + 'jpg/convert_to_cmyk_illustrator.jpg?c3d=104" target="_blank" style="font-size:0.7rem;">'+ this.lang['screenshot'] +'</a>');
            notice = notice.replace('[COREL_SCREENSHOT]', '<a href="' + C3D_SERVER + 'jpg/convert_to_cmyk_corel.jpg?c3d=104" target="_blank" style="font-size:0.7rem;">'+ this.lang['screenshot'] +'</a>');
    ...
    async _createMaterials(mesh, materials = [])
    {
        ...
        for (let i = 0; i < materials.length; i++)
        {
            ...
            else if(data.hasOwnProperty('solid'))
            {
                ...
                img.src = C3D_SERVER + 'svg/solid.svg?c3d=104';
                img.alt = 'Icon';
            ...
            else if(data.hasOwnProperty('text'))
            {
                ...
                img.src = C3D_SERVER + 'svg/text.svg?c3d=104';
                img.alt = 'Icon';
            ...
            else if(data.hasOwnProperty('image'))
            {
                ...
                img.src = C3D_SERVER + 'svg/image.svg?c3d=104';
                img.alt = 'Icon';
            ...
            else
            {
                ...
                <div class="button solid" title="${this.lang['add-solid-layer']}">
                    <img src="${C3D_SERVER}svg/solid.svg?c3d=104" alt="Icon" draggable="false">
                </div>

                <div class="button gradient" title="${this.lang['add-gradient-layer']}">
                    <img src="${C3D_SERVER}svg/gradient.svg?c3d=104" alt="Icon" draggable="false">
                </div>

                <div class="button text" title="${this.lang['add-text-layer']}">
                    <img src="${C3D_SERVER}svg/text.svg?c3d=104" alt="Icon" draggable="false">
                </div>

                <div class="button image" title="${this.lang['add-image-layer']}">
                    <img src="${C3D_SERVER}svg/image.svg?c3d=104" alt="Icon" draggable="false">
                </div>

                <div class="button threeD" title="${this.lang['add-3d-model']}">
                    <img src="${C3D_SERVER}svg/3D.svg?c3d=104" alt="Icon" draggable="false">
                </div>

                <div class="button shape" title="${this.lang['add-shape-layer']}">
                    <img src="${C3D_SERVER}svg/shapes.svg?c3d=104" alt="Icon" draggable="false">
                </div>
                `;
