...
import {ThreeDText} from 'customizer3D_dir/layers/types/ThreeDText.js?c3d=103';
...
export class Text
{
    ...
    async _init()
    {
        ...
        div.innerHTML = `
            ...
            <img src="${C3D_SERVER}svg/delete-bin.svg?c3d=103" title="${this.c3d.lang['delete-layer']}" class="delete-layer">
        `;
