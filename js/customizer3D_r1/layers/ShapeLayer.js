            ...
            <div class="menu">
                <div class="freeform">
                    <div class="button" title="${this.c3d.lang['freeform']}">
                        <img src="${C3D_SERVER}svg/freeform.svg" alt="Icon">
                    </div>
                    <div class="list"></div>
                </div>
                <div class="triangle">
                    <div class="button" title="${this.c3d.lang['triangle']}">
                        <img src="${C3D_SERVER}svg/triangle.svg" alt="Icon">
                    </div>
                    <div class="list"></div>
                </div>
                <div class="circle">
                    <div class="button" title="${this.c3d.lang['circle']}">
                        <img src="${C3D_SERVER}svg/circle.svg" alt="Icon">
                    </div>
                    <div class="list"></div>
                </div>
                <div class="square">
                    <div class="button" title="${this.c3d.lang['square']}">
                        <img src="${C3D_SERVER}svg/square.svg" alt="Icon">
                    </div>
                    <div class="list"></div>
                </div>
            </div>
            ...
            <div style="padding-top:0.25rem;">
                ...
                <div class="radius">
                    <div class="button" title="${this.c3d.lang['radius']}">
                        <img src="${C3D_SERVER}svg/radius.svg" alt="Icon">
                    </div>
                    <div class="list">
