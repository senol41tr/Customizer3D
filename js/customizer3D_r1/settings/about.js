export const about = async (c3d, container) =>
{
    ...
    content.innerHTML = `
        <img src="${C3D_SERVER}svg/customizer_3D_logo.svg?c3d=103" alt="Customizer3D Logo" class="logo">
        ...
        <div>
            <p>PDF.js</p>
            <a href="https://mozilla.github.io/pdf.js?c3d=103" target="_blank">#</a>
        </div>
        <div>
            <p>jsColorEngine</p>
        ...
        <div>
            <p>JS Color Picker</p>
            <a href="https://www.jscolorpicker.com?c3d=103" target="_blank">#</a>
        </div>
        <div>
            <p>opentype.js</p>
            <a href="https://opentype.js.org?c3d=103" target="_blank">#</a>
        </div>
        <div>
            <p>fflate</p>
