...
import {langs} from './langs.js?c3d=103';
import {changeUIColors, tintSVG} from './changeUIColors.js?c3d=103';
import {GPUInfo} from './GPUInfo.js?c3d=103';
import * as PDFExportOptions from './pdfExportOptions.js?c3d=103';
import {takeAScreenshot} from './takeAScreenshot.js?c3d=103';
import {about} from './about.js?c3d=103';
import {stats} from './stats.js?c3d=103';
...
export class Settings
{
    ...
    async init()
    {
        ...
        <div class="title">
            <div class="title">
                <img src="${C3D_SERVER}svg/settings.svg?c3d=103" alt="Icon" class="icon" draggable="false">
            </div>
        </div>
