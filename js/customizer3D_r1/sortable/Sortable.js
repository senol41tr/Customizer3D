...
export class Sortable2
{
    ...
    addElement(root)
    {
        ...
        div.innerHTML = `
            <img class="up" src="${C3D_SERVER}svg/arrow-drop-down.svg" style="cursor:pointer; width:8px; rotate:180deg; opacity:0.7;" alt="Arrow Icon">
            <img class="down" src="${C3D_SERVER}svg/arrow-drop-down.svg" style="cursor:pointer; width:8px;opacity:0.7;" alt="Arrow Icon">
        `;
