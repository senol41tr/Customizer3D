...
import { toTrianglesDrawMode } from '../utils/BufferGeometryUtils.js?c3d=102';
import { clone } from '../utils/SkeletonUtils.js?c3d=102';
 ...
 *
 * @augments Loader
 * @three_import import { GLTFLoader } from 'three/addons/loaders/GLTFLoader.js?c3d=102';
 */
class GLTFLoader extends Loader {
	...
	load( url, onLoad, onProgress, onError ) {
		...
		if ( this.resourcePath !== '' ) {
			...
			// referenced resource '../textures/texture.png?c3d=102' will be loaded from 'https://my-cnd-server.com/assets/textures/texture.png?c3d=102'
