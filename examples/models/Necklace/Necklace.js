    ...
    return {
        ...
        data:
        {
            chain:
            {
                ...
                materials:
                [
                    {url:root + 'matcap-1764731458681.jpg?c3d=103', material:'MeshMatcapMaterial'},
                    {url:root + 'matcap-1764731647559.jpg?c3d=103', material:'MeshMatcapMaterial'},
                    {url:root + 'matcap-1764787557882.jpg?c3d=103', material:'MeshMatcapMaterial'}
                ]
            },
            heart:
            {
                ...
                [
                    ...
                    {url:root + 'matcap-1764731647559.jpg?c3d=103', material:'MeshMatcapMaterial'},
                    {url:root + 'matcap-1764787557882.jpg?c3d=103', material:'MeshMatcapMaterial'},
                    {url:root + 'matcap-1764731550075.jpg?c3d=103', material:'MeshMatcapMaterial'}
                ]
            }
        }
    };
