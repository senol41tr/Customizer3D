    ...
    return {
        ...
        data:
        {
            chain:
            {
                ...
                materials:
                [
                    {url:root + 'matcap-1764731458681.jpg', material:'MeshMatcapMaterial'},
                    {url:root + 'matcap-1764731647559.jpg', material:'MeshMatcapMaterial'},
                    {url:root + 'matcap-1764787557882.jpg', material:'MeshMatcapMaterial'}
                ]
            },
            heart:
            {
                ...
                [
                    ...
                    {url:root + 'matcap-1764731647559.jpg', material:'MeshMatcapMaterial'},
                    {url:root + 'matcap-1764787557882.jpg', material:'MeshMatcapMaterial'},
                    {url:root + 'matcap-1764731550075.jpg', material:'MeshMatcapMaterial'}
                ]
            }
        }
    };
