    ...
    return {
        ...
        data:
        {
            cabinet:
            {
                ...
                [
                    {
                        url: root + 'cabinet/dark.jpg?c3d=104', 
                        repatX: 4, 
                        repeatY: 4, 
                    ...
                    {
                        url: root + 'cabinet/middle.jpg?c3d=104', 
                        repatX: 4, 
                        repeatY: 4, 
                        material: 'MeshStandardMaterial', 
                        materialOptions:
                    ...
                    {
                        url: root + 'cabinet/light.jpg?c3d=104', 
                        repatX: 4, 
                        repeatY: 4, 
                        material: 'MeshStandardMaterial', 
                        materialOptions:
            ...
            marmour:
            {
                ...
                [
                    {
                        url: root + 'marmour/black_gold.jpg?c3d=104', 
                        material: 'MeshStandardMaterial', 
                        materialOptions: 
                        {
                            metalness: 0.75, 
                    ...
                    {
                        url: root + 'marmour/white_gold.jpg?c3d=104', 
                        material: 'MeshStandardMaterial', 
                        materialOptions: 
                        {
                            metalness: 0.75, 
                    ...
                    {
                        url: root + 'marmour/middle.jpg?c3d=104', 
                        material: 'MeshStandardMaterial', 
                        materialOptions: 
                        {
                            metalness: 0.75, 
                    ...
                    {
                        url: root + 'marmour/black.jpg?c3d=104', 
                        material: 'MeshStandardMaterial', 
                        materialOptions: 
                        {
                            metalness: 0.75, 
                    ...
                    {
                        url: root + 'marmour/white.jpg?c3d=104', 
                        material: 'MeshStandardMaterial', 
                        materialOptions: 
                        {
                            metalness: 0.75, 
            ...
            metal_pieces:
            {
                ...
                [
                    {
                        url: root + 'metal_pieces/gold.jpg?c3d=104', 
                        material: 'MeshMatcapMaterial'
                    },
                    {
                        url: root + 'metal_pieces/anthracite.jpg?c3d=104', 
                        material: 'MeshMatcapMaterial'
                    },
                    {
                        url: root + 'metal_pieces/metal.jpg?c3d=104', 
                        material: 'MeshMatcapMaterial'
                    },
                    {
                        url: root + 'metal_pieces/green_metal.jpg?c3d=104', 
                        material: 'MeshMatcapMaterial'
                    },
                    {
                        url: root + 'metal_pieces/orange_metal.jpg?c3d=104', 
                        material: 'MeshMatcapMaterial'
                    },
                    {
                        url: root + 'metal_pieces/red_metal.jpg?c3d=104', 
                        material: 'MeshMatcapMaterial'
                    },
                    {
                        url: root + 'metal_pieces/white_metal.jpg?c3d=104', 
                        material: 'MeshMatcapMaterial'
                    }
                ]
            }
